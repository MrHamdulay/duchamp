...
\item Alternatively (and if requested), the cube is smoothed, either
  ...
  separately, and smoothes it with a Gaussian kernel of size chosen by
  the user. This step can help to reduce the amount of noise visible
  in the cube and enhance fainter sources.
