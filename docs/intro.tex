...
\duchamp searches fro groups of connected voxels (or pixels) that are
all above some flux threshold. No assumption is made as to the shape
of detections, and the only size constraints applied are those
