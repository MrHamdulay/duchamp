...
criteria are not applied at this point - see \S\ref{sec-reject} for
details. 
...
\texttt{minChannels} consecutive channels to be accepted.
...
by setting \texttt{flagRejectBeforeMerge=true} - caution is urged if
you use this in conjunction with \texttt{flagTwoStageMerging=false}. 