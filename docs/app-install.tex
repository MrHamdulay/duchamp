...
use the \texttt{--prefix} option with configure, \eg
\begin{quote}
{\footnotesize
\texttt{%
> ./configure --prefix=/home/mduchamp/bin}
}
\end{quote}
and then run \texttt{make} and \texttt{make install} as stated above. 
...
\end{quote}
And then just run \texttt{make} in the usual fashion.
