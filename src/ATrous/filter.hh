...
namespace duchamp
{
    ...
    /// @brief A base class to store details of the wavelet's filter.
    ...
    ///
    /// Specific filters should derive from this class, and define the
    /// filter coefficients in the constructor.
