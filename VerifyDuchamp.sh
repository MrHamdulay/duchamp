...
diff -I"New run of the Duchamp sourcefinder" -I"Duchamp completed:" verification/log1.txt verification/stdLog1.txt
...
echo "Differences with Log:"
diff -I"New run of the Duchamp sourcefinder" -I"Duchamp completed:" verification/log2.txt verification/stdLog2.txt
...
echo "Differences with Log:"
diff -I"New run of the Duchamp sourcefinder" -I"Duchamp completed:" verification/log4.txt verification/stdLog4.txt
...
echo "Differences with Log:"
diff -I"New run of the Duchamp sourcefinder" -I"Duchamp completed:" verification/log3.txt verification/stdLog3.txt
